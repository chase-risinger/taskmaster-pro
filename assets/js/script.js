...
$(".card .list-group").sortable({
  ...
  scroll: false,
  tolerance: "pointer",
  helper: "clone", // creates a copy of the dragged element and moves that instead of the original, prevents clicks from accidentally triggering on the original element.
